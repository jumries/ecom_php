...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'https://localhost/ecom/SSLCommerz'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'limme5e92958f76c27'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'limme5e92958f76c27@ssl'); // your store password.
}
